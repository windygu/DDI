...
namespace ORG.UILib
{
    public class PrintDataGridView
    {
        ...
        public static void Print(DataGridViewEx dataGridView, bool includeColumnText, PrintPageEventArgs eValue, ref int PoX, ref int PoY)
        {
        ...
        /// <param name="dataGridView">DataGridView控件</param>
        /// <param name="includeColumnText">是否包括列标题</param>
        private static void DataGridViewCellVsList(DataGridViewEx dataGridView, bool includeColumnText)
        {
            CellPrintList.Clear();
            try
            {
