...
namespace ORG.UILib.Controls
{
    public partial class DataGridViewEx : DataGridView
    {
        ...
        /// 按配置顺序显示列
        /// </summary>
        [Description("设置是否启用是否设置保存column  Width功能")]
        ...
        {
            decimal num = 0M;
            if (this.SumColumnList != null && this.dgvTotalRow != null)
            {
