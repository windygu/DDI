<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DdiConfigList.aspx.cs"
    Inherits="DDIWebApp.DDI.DdiConfigList" %>

<%@ Register Assembly="DiyAspNetPager" Namespace="Diy.Pager" TagPrefix="diyAsp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>数据传输配置列表</title>
                ...
                <tr>
                    ...
                    <td  align="left">
                        <asp:DropDownList ID="DropDownListFileType" Width="185px" runat="server" Height="26px" CssClass="Cddl">
                            ...
                            <asp:ListItem Enabled="true" Text="Excel97_2003" Value="1"></asp:ListItem>
                ...
                <Columns>
                    <asp:TemplateField ControlStyle-Width="30" HeaderText="选择">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="ManualDownload" runat="server" Value='<%#Eval("ManualDownload") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="30px" HeaderText="编辑操作" Visible="true">
                        <ItemTemplate>
                            <asp:Panel ID="panel" runat="server">
                                <a href='DdiConfigEdit.aspx?id=<%#Eval("id") %>' style="color: #0000FF">编辑</a>
                            </asp:Panel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="30px" HeaderText="重采操作" Visible="true">
                        <ItemTemplate>
                            <asp:Panel ID="panel1" runat="server">
                               <a href='HeavyMiningExecuteConfig.aspx?id=<%#Eval("id") %>' style="color: #0000FF">重采</a>
                            </asp:Panel>
                        </ItemTemplate>
                    </asp:TemplateField>
